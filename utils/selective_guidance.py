...
""" MODIFICATIONS
- Disabled NSFW content checker
- Added Selective guidance method
"""
...
class StableDiffusionPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        start_opt_iter = round(max_iter * (1 - opt_percentage / 100.0))     # when to start Selective Guidance
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # perform guidance
                if do_classifier_free_guidance:
                    # Apply Selective Guidance optimization
                    if i >= start_opt_iter:
