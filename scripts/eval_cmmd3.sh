...
CUDA_VISIBLE_DEVICES=0 python cmmd_pytorch/main.py data/val_fid2014/mscoco_val2014 main_exps_fid/coco_PAG_gen_sdv15 --batch_size=256 --max_count=30000 > main_exps_fid/cmmd_metrics/enhance_sbv2_81_viet_inv_sd21.txt
